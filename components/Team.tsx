...
const Star: React.FC<StarProps> = ({ 
  ...
  return (
    <div 
      className={`absolute text-white ${sizeClasses[size]} pointer-events-none select-none animate-pulse ${mobileHidden ? 'hidden sm:block' : ''}`}
      style={positionStyle}
    >
      ✦
    </div>
...
const DataTransitionHero: React.FC = () => {
  ...
  const stars: StarProps[] = [
    ...
    { top: '70%', right: '15%', size: 'sm', opacity: 0.3, rotation: 45, mobileHidden: true },
