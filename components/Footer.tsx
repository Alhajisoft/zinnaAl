        ...
        <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="geometric" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
              <polygon points="50,0 100,25 100,75 50,100 0,75 0,25" fill="none" stroke="white" strokeWidth="0.5"/>
              <polygon points="25,12.5 75,12.5 87.5,37.5 75,62.5 25,62.5 12.5,37.5" fill="none" stroke="white" strokeWidth="0.3"/>
        ...
        <div className="container mx-auto px-6 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2">
              <h3 className="text-lg font-semibold mb-6 text-white relative">
                Contact
                <div className="absolute -bottom-2 left-0 w-8 h-0.5 bg-gradient-to-r from-green-500 to-blue-500"></div>
              </h3>
              <div className="space-y-4">
                ...
                <div className="group">
                  {contactInfo.address.map((line, index) => (
                    <p key={index} className="text-gray-300 group-hover:text-white transition-colors duration-300">
                      {line}
                    </p>
                  ))}
                </div>
                ...
                <div className="flex space-x-4">
                  {socialLinks.map((social) => (
                    <a
                      ...
                      className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center text-gray-400 hover:text-white hover:bg-gradient-to-r hover:from-blue-500 hover:to-purple-500 transition-all duration-300 transform hover:scale-110"
                    >
                      {social.icon}
                    </a>
                  ))}
